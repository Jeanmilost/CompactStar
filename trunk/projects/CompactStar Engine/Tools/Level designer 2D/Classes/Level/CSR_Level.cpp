...
bool CSR_Level::AddSkybox(const IFileNames& fileNames, ITfLoadCubemap fLoadCubemap)
{
    ...
    m_pScene->m_pSkybox->m_Shader.m_CubeMapID = fLoadCubemap(fileNames);
                              ...
                              ITfSelectModel     fSelectModel)
{
    ...
    {
        // load the texture
        pBox->m_Shader.m_TextureID = fLoadTexture(textureName);
                                   ...
                                   ITfSelectModel     fSelectModel)
{
    ...
    {
        // load the texture
        pCylinder->m_Shader.m_TextureID = fLoadTexture(textureName);
                               ...
                               ITfSelectModel     fSelectModel)
{
    ...
    {
        // load the texture
        pDisk->m_Shader.m_TextureID = fLoadTexture(textureName);
                               ...
                               ITfSelectModel     fSelectModel)
{
    ...
    {
        // load the texture
        pRing->m_Shader.m_TextureID = fLoadTexture(textureName);
                                 ...
                                 ITfSelectModel     fSelectModel)
{
    ...
    {
        // load the texture
        pSphere->m_Shader.m_TextureID = fLoadTexture(textureName);
                                 ...
                                 ITfSelectModel     fSelectModel)
{
    ...
    {
        // load the texture
        pSpiral->m_Shader.m_TextureID = fLoadTexture(textureName);
                                  ...
                                  ITfSelectModel     fSelectModel)
{
    ...
    {
        // load the texture
        pSurface->m_Shader.m_TextureID = fLoadTexture(textureName);
                                    ...
                                    ITfSelectModel     fSelectModel)
{
    ...
    {
        // load the texture
        pModel->m_pMesh[0].m_Shader.m_TextureID = fLoadTexture(textureName);
                              ...
                              ITfSelectModel     fSelectModel)
{
    ...
    // load the MDL model
    if (pBuffer)
        pMDL = csrMDLCreate(pBuffer, 0, &vf, 0, &material, 0, 0);
    else
        pMDL = csrMDLOpen(fileName.c_str(), 0, &vf, 0, &material, 0, 0);
...
//---------------------------------------------------------------------------
CSR_Shader* CSR_Level::OnGetShader(const void* pModel, CSR_EModelType type)
{
