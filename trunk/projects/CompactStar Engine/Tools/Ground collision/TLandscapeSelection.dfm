object LandscapeSelection: TLandscapeSelection
  Left = 0
  Top = 0
  AutoSize = True
  BorderStyle = bsDialog
  Caption = 'Landscape selection'
  ClientHeight = 495
  ClientWidth = 400
  Color = clBtnFace
  ...
  object paSource: TPanel
    ...
    object rbSourceBitmap: TRadioButton
      AlignWithMargins = True
      Left = 3
      Top = 33
      Width = 394
      Height = 25
      Align = alTop
      Caption = 'From a grayscale bitmap (or image)'
      Checked = True
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -16
    ...
    object rbSourceDontModify: TRadioButton
      AlignWithMargins = True
      Left = 3
      Top = 222
      Width = 394
      Height = 25
      Align = alTop
      Caption = 'Do not change the landscape model'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -16
      Font.Name = 'Tahoma'
