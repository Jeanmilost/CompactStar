...
int LoadLandscapeFromBitmap(const char* pFileName)
{
    ...
    CSR_VertexFormat  vf         = {};
    CSR_Model*        pModel     = nullptr;
    CSR_PixelBuffer*  pBitmap    = nullptr;
                      ...
                      _In_     int       nCmdShow)
{
    ...
    wcex.lpszClassName = L"CSR_BotDemo";
