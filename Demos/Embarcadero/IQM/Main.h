...
/**
* Inter-Quake Model demo main form
...
class TMainForm : public TForm
{
    ...
    public:
        ...
        */
        static void OnGetIQMIndexCallback(const CSR_IQM* pIQM, size_t* pAnimSetIndex, size_t* pFrameIndex);
    ...
    private:
        ...
        *@param[out] pMatrix - built model matrix
        */
