...
bool InitScene(int w, int h)
{
    ...
    g_Goal.m_Bounds.m_Min.m_X = std::min(goalBox.m_Min.m_X, goalBox.m_Max.m_X);
    g_Goal.m_Bounds.m_Min.m_Y = std::min(goalBox.m_Min.m_Z, goalBox.m_Max.m_Z);
    g_Goal.m_Bounds.m_Max.m_X = std::max(goalBox.m_Min.m_X, goalBox.m_Max.m_X);
    g_Goal.m_Bounds.m_Max.m_Y = std::max(goalBox.m_Min.m_Z, goalBox.m_Max.m_Z);
                   ...
                   int       nCmdShow)
{
    ...
    wcex.lpszClassName = "CSR_WildSoccer";
